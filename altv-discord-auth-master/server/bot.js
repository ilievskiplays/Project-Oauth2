...
const config = {
    botTokenSecret: process.env['NzUzNjk0MTA3MzY0MjI5MjEx.X1p6Vg.9ksbYFIX8GvDYcNHjOffTywzZOA'],
    serverId: process.env['737967060801421423'],
    clientId: process.env['753694107364229211'],
    roleWhitelistId: process.env['777212929849294888'],
};
